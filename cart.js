...
const createSmallcards = (data) => {
    ...
    const itemAsNumber = parseInt(data.item);
    if (isNaN(priceAsNumber)) {
        console.log('Price as Number:', priceAsNumber);    }
        else {
            console.log('Price as Number:', priceAsNumber);
            console.log('Total Price:', priceAsNumber * data.item);
        }
    ...
    <p class="sm-price" data-price="₹${priceAsNumber * data.item}">
    ₹${priceAsNumber * data.item}
</p>

    <button class="sm-delete-btn"><img src="assets/reject.png" alt=""></button>
</div>`;
}
...
const setCartProducts = () => {
    ...
    if(cart == null || !cart.length){
        cartContainer.innerHTML += `<img src="assets/emptycart.png" class="empty-img" alt="">`
    }else{
